...
def test_hashsplit_boundaries():
    ...
    # Check keep_boundaries when the data has no split_pointss
    def bio(s):
        return BytesIO(s)
    ...
    # Check keep_boundaries when the data has internal split_pointss
    def split_bytes(n):
        return BytesIO(split_test_objs[n])
    def ex(n):
        p = n
    ...
    # Check keep_boundaries when the data has no internal split_pointss
